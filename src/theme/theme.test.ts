...
describe('theme preference', () => {
  ...
  it.each([
    ...
    '--theme-graph-toolbar-surface',
    '--theme-graph-toolbar-icon',
    '--theme-graph-toolbar-border',
    '--theme-graph-toolbar-hover',
    '--theme-graph-toolbar-active',
    '--theme-graph-toolbar-active-icon',
    '--theme-graph-toolbar-disabled',
    '--theme-graph-toolbar-danger',
    '--theme-element-text',
