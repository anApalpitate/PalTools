...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { id: 'qwen-cn', label: '通义千问（中国内地）', transport: 'openai-chat', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', authMode: 'bearer', modelPlaceholder: '填写 DashScope 模型 ID', docsUrl: 'https://help.aliyun.com/zh/model-studio/get-api-key/', note: '使用阿里云百炼中国内地兼容接口。' },
