...
这里存放已完成阶段的方案、技术评估和发布记录。agent 默认不主动阅读，只有追溯历史时才查看；当前规范见 [`../reference/README.md`](../reference/README.md)。它们用于追溯决策，不作为当前实现与验收的首要依据；当前行为以代码、[`../README.md`](../README.md)、架构和数据验证器为准。
...
| [03-next-phase-recommendations.md](03-next-phase-recommendations.md) | 第四阶段候选分析，当前需求以 `../tasks/todolist.md` 为准 |
...
| [2026-08-01-breeding-slot-tree-requirements.md](2026-08-01-breeding-slot-tree-requirements.md) | REQ-010–013 曾完成，相关功能已于 2026-08-10 按 REQ-002 移除 |
