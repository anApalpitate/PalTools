...
唯一当前产品待办为 REQ-003：用户从正向或反向查询结果中收集精确配方，系统由关系集合自动构建高可见方案网和等价文本步骤。需求已经确认但尚未实现，范围和验收以[配种方案网需求](../tasks/2026-08-10-breeding-solution-network-requirements.md)为准。
